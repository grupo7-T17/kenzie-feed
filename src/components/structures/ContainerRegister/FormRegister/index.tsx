...
import { StyledFormRegister, StyledRegisterFormButton, StyledRegisterInput } from "./style";
...
export const FormRegister = () => {
  ...
  return (
    <StyledFormRegister>
      ...
      <StyledButton buttonType="primary" buttonSize="md-min">Cadastrar-se</StyledButton>
